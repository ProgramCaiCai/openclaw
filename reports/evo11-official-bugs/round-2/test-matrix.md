...
| BUG-23427-01 | stale action path while reachable handshake | `isReachable=true`, `listTabs fail` | `cdpReady=false` | PASS (test added) |
| BUG-23801-01 | identical block/final payload | same payload twice | single send | PASS (test added) |
