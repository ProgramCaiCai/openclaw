      ...
      return {
        ...
        details: (() => {
          ...
          if (
            ...
            (base.text as string).length > EXCLUDED_CONTEXT_PREVIEW_CHARS
          ) {
            base.text = tailText(base.text as string, EXCLUDED_CONTEXT_PREVIEW_CHARS);
          }
          if (
            typeof base.markdown === "string" &&
            (base.markdown as string).length > EXCLUDED_CONTEXT_PREVIEW_CHARS
          ) {
            base.markdown = tailText(base.markdown as string, EXCLUDED_CONTEXT_PREVIEW_CHARS);
          }
          return {
            ...base,
